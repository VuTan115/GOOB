        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.only(top: r * 4, right: r * 4, bottom: r * 2, left: r * 4),
                  child: Row(
                        ...
                        child: Row(
                          children: <Widget>[
                            SizedBox(
                              width: 18.0,
                              height: 16.0,
                              child: SvgPicture.asset(LightIcons.sunCloud, color: Colors.white),
                            ),
                            Text(" Nắng đẹp, ",
                                style: TextStyle(fontSize: r * 15, color: Colors.white)),
                            Text("36ºC", style: TextStyle(fontSize: r * 15, color: Colors.white)),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            SizedBox(
                              width: 14.0,
                              height: 14.0,
                              child: SvgPicture.asset(LightIcons.mapMarkerAlt, color: Colors.white),
                            ),
                            Text(" Đống Đa, Hà Nội",
                                style: TextStyle(fontSize: r * 15, color: Colors.white)),
                          ],
                ...
                Padding(
                  padding: EdgeInsets.only(top: r * 12, right: r * 12, bottom: r * 8, left: r * 12),
                  child: Column(
                    children: [
                      TextField(
                        style: TextStyle(fontSize: r * 18, color: Colors.black87),
                        decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.all(Radius.circular(r * 30)),
                          ...
                          suffixIcon: Icon(Icons.search, color: Colors.black45, size: r * 28),
                          suffixIconConstraints:
                              BoxConstraints(minWidth: r * 48, minHeight: r * 48),
                        ),
                      ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ButtonTheme(
                              ...
                              child: OutlineButton(
                                padding: EdgeInsets.symmetric(vertical: 0.0, horizontal: r * 8),
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(r * 14)),
                                borderSide: BorderSide(width: 0.5, color: Colors.white),
                                child: Text('167 An Trạch...',
                                    style: TextStyle(fontSize: r * 14, color: Colors.white),
                  ...
                  builder: (BuildContext context) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        image: DecorationImage(
                            image: AssetImage('assets/images/ads/slider_' + i.toString() + '.jpg'),
                            fit: BoxFit.fill),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.symmetric(vertical: r * 8, horizontal: r * 12),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          child: Text(
                            'Xem thêm',
                            style: TextStyle(fontSize: r * 14, color: Colors.black45),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ),
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(
                                width: r * 50,
                                height: r * 50,
                                child: SvgPicture.asset(LightIcons.searchLocation,
                                    color: const Color.fromRGBO(255, 255, 255, 0.9)),
                              ),
                              Separator(height: r * 12),
                              Text("ĐỊA ĐIỂM",
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(
                                width: r * 50,
                                height: r * 50,
                                child: SvgPicture.asset(LightIcons.creditCardFront,
                                    color: const Color.fromRGBO(255, 255, 255, 0.9)),
                              ),
                              Separator(height: r * 12),
                              Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlineButton(
                          ...
                          shape:
                              RoundedRectangleBorder(borderRadius: BorderRadius.circular(r * 12)),
                          child: Text('Xem thêm',
                              style: TextStyle(fontSize: r * 14, color: Colors.black45),
                              overflow: TextOverflow.ellipsis),
                          onPressed: () {},
                ...
                Container(
                  //height: r * 280,
                  constraints: BoxConstraints(minHeight: r * 250, maxHeight: r * 280),
                  padding: EdgeInsets.symmetric(vertical: r * 8, horizontal: r * 12),
                  child: ListView.separated(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: AssetImage('assets/images/ads/diadiem.jpg')),
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: r * 8.0, right: r * 8.0, bottom: r * 3.0, left: r * 8.0),
                              child: Text('Bún chả Hàng Quạt',
                                  style: TextStyle(fontSize: r * 16, fontWeight: FontWeight.bold),
                                  overflow: TextOverflow.ellipsis),
                            ),
                            Padding(
                              padding: EdgeInsets.only(
                                  top: r * 3.0, right: r * 8.0, bottom: r * 3.0, left: r * 8.0),
                              child: Text('208 Hàng Quạt, Hai Bà Trưng, Hà Nội, Việt Nam',
                                  style: TextStyle(fontSize: r * 14, color: Colors.teal),
                                  overflow: TextOverflow.ellipsis),
                            ),
                            Padding(
                              padding: EdgeInsets.only(
                                  top: r * 3.0, right: r * 8.0, bottom: r * 8.0, left: r * 8.0),
                              child: Text('Mở cửa: 7h30 - 22h00 | T2 - CN',
                                  style: TextStyle(fontSize: r * 14, color: Colors.orange),
                                  overflow: TextOverflow.ellipsis),
                            ),
                          ],
                        ),
                    ...
                    separatorBuilder: (BuildContext context, int index) => Separator(width: r * 12),
                  ),
                ),
              ],
            ),
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  Image(image: AssetImage('assets/images/ads/Banner-Giay-Dr-Martens-1290x800.png')),
                  Positioned(
                    top: r * 6,
                    right: r * 10,
                    child: SizedBox(
                      width: r * 24,
                      height: r * 24,
                      child: SvgPicture.asset(LightIcons.ad, color: Colors.white54),
                    ),
                  ),
                ],
              ),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: AssetImage('assets/images/ads/sanpham1.jpg'),
                                ),
                                borderRadius: const BorderRadius.only(
                                    topLeft: Radius.circular(2.0), topRight: Radius.circular(2.0)),
                              ),
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: r * 8, right: r * 8, bottom: r * 3, left: r * 8),
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  top: r * 3, right: r * 8, bottom: r * 8, left: r * 8),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  color: const Color.fromRGBO(250, 250, 250, 1.0),
                  padding: EdgeInsets.symmetric(vertical: r * 6, horizontal: r * 12),
                  child: Center(
                    child: Card(
                      shape: RoundedRectangleBorder(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ListTile(
                            dense: true,
                            contentPadding: EdgeInsets.symmetric(horizontal: r * 10),
                            visualDensity: const VisualDensity(horizontal: -4, vertical: 0),
                            leading: IconButton(
                              icon: SizedBox(
                                width: r * 42,
                                height: r * 42,
                                child: SvgPicture.asset(LightIcons.grin, color: Colors.black54),
                              ),
                              tooltip: 'Vào trang riêng của Lê Ngọc Anh',
                              padding: const EdgeInsets.all(0.0),
                              onPressed: () {},
                            ),
                            title: Text('Lê Ngọc Anh',
                                style: TextStyle(
                                    fontSize: r * 17,
                                    fontWeight: FontWeight.bold,
                                    color: const Color.fromRGBO(0, 0, 0, 0.7))),
                            subtitle:
                                Text('Đăng bán mặt hàng mới.', style: TextStyle(fontSize: r * 13)),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                SizedBox(
                                  width: r * 40,
                                  child: IconButton(
                                    icon: Icon(Icons.favorite_outline_outlined, size: r * 22),
                                    tooltip: 'Quan tâm',
                                    onPressed: () {},
                                  ),
                                ),
                          ...
                          InkWell(
                            child: Container(
                              ...
                              child:
                                  Image(image: AssetImage('assets/images/ads/image001_korf.jpg')),
                            ),
                            onTap: () {},
                          ),
                          Container(
                          ...
                          Container(
                            padding: EdgeInsets.only(left: r * 16.0, right: r * 8.0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Row(
                                ...
                                ButtonTheme(
                                  ...
                                  child: FlatButton(
                                    ...
                                    padding:
                                        EdgeInsets.symmetric(vertical: 0.0, horizontal: r * 10),
                                    child: Row(
                                      children: [
                                        Text('CHI TIẾT',
                                            style:
                                                TextStyle(color: Colors.black54, fontSize: r * 16)),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            title: Text('Trần Thanh Hương',
                                style: TextStyle(
                                    ...
                                    color: const Color.fromRGBO(0, 0, 0, 0.7))),
                            subtitle:
                                Text('Đăng đánh giá mới.', style: TextStyle(fontSize: r * 13)),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                SizedBox(
                          ...
                          InkWell(
                            child: Container(
                              width: MediaQuery.of(context).size.width,
                              child: Image(image: AssetImage('assets/images/ads/muongthanh.jpg')),
                            ),
                            onTap: () {},
                          ),
                          Container(
                            padding: EdgeInsets.all(r * 10),
                            child: Text("Đánh giá 4.5 sao cho khách sạn Mường Thanh - Tây Hồ",
                                style: TextStyle(fontSize: r * 17)),
                          ),
                          const Divider(height: 0),
                          Container(
                            padding: EdgeInsets.only(left: r * 16, right: r * 8),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                // Row(
                                ...
                                // ),
                                Row(children: <Widget>[
                                  Icon(Icons.star_rounded, size: r * 20, color: Colors.yellow),
                                  Icon(Icons.star_rounded, size: r * 20, color: Colors.yellow),
                                  Icon(Icons.star_rounded, size: r * 20, color: Colors.yellow),
                                  Icon(Icons.star_rounded, size: r * 20, color: Colors.yellow),
                                  Icon(Icons.star_half_rounded, size: r * 20, color: Colors.yellow)
                                ]),
                                ButtonTheme(
                                  minWidth: r * 50,
                                  height: r * 30,
                          ...
                          ListTile(
                            ...
                            title: Text('Lê Nguyễn Hoài Thu',
                                style: TextStyle(
                                    ...
                                    color: const Color.fromRGBO(0, 0, 0, 0.7))),
                            subtitle:
                                Text('Đăng tìm mua sản phẩm.', style: TextStyle(fontSize: r * 13)),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                SizedBox(
                                  width: r * 40,
                                  child: IconButton(
                                    icon: Icon(Icons.favorite_outline_outlined, size: r * 22.0),
                                    tooltip: 'Quan tâm',
                                    onPressed: () {},
                                  ),
                                ),
                                    ...
                                    child: Row(
                                      children: [
                                        SizedBox(
                                          width: 10,
                                          height: 10,
                                          child: SvgPicture.asset(RegularIcons.link,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            leading: IconButton(
                              icon: SizedBox(
                                width: r * 42,
                                height: r * 42,
                                child: SvgPicture.asset(LightIcons.grinTongueWink,
                          ...
                          InkWell(
                            child: Container(
                              width: media.width,
                              child: Image(image: AssetImage('assets/images/ads/sanpham.jpg')),
                            ),
                            onTap: () {},
                          ),
                          Container(
                          ...
                          ListTile(
                            ...
                            leading: IconButton(
                              icon: SizedBox(
                                width: r * 42,
                                height: r * 42,
                                child: SvgPicture.asset(LightIcons.grinBeam, color: Colors.black45),
                              ),
